namespace ChatBotHabitat.Dialogs
{
...
using ChatBotHabitat.Entities;
using ChatBotHabitat.Utils;
...
using Google.Apis.QPXExpress.v1.Data;
    ...
    public class ChatBotLuisDialog : LuisDialog<object>
    {
        ...
        public async Task TestFlight(IDialogContext context, LuisResult result)
        {
            ...
            x.Request.Slice.Add(new SliceInput() { Origin = "ADD", Destination = "NBO", Date = "2017-03-05" });
